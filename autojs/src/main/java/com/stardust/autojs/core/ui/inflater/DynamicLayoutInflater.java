...
import com.stardust.autojs.core.ui.inflater.inflaters.JsCheckBoxInflater;
...
public class DynamicLayoutInflater {
    ...
    protected void registerViewAttrSetters() {
        ...
        registerViewAttrSetter(JsCheckBox.class.getName(), new JsCheckBoxInflater(mResourceParser));
